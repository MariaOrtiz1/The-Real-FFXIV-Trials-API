...
app.get('/trials', async(req, res) => {
  try {
    ...
    VALUES ('The Dying Grasp', 80, 410, 'Hades', 'Full Party, 8 man', '10 Allagan Tomestones of Allegory, 5 Allagan Tomestone of Revelation', 'Hades Card, Shoebill minion', 'Shadowbringers', 1)`);
